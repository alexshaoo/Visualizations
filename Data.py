...
class Data:
    ...
    descriptions = [["An inscribed angle is an angle formed by three points on the circumference of a circle.",
                     "A central angle is an angle formed by two points on the circumference of a circle, "
                     "and the center of that circle.",
                    ...
                    ["This applies to triangles which have two vertices on diametrically opposite sides of a circle.",
                     "It states that the angle formed between those two vertices and another will always be a right "
                     "angle."],
                    ...
                    ["A line is drawn tangent to a point on a circle's circumference.",
                     "This line will always form a right angle with the line connecting the circle's center with its "
                     "point of tangency."]]
